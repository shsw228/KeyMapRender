...
public final class AppModel: ObservableObject {
    ...
    @Published public var targetKeyCodeText: String
    @Published public var longPressDuration: Double
    ...
    @Published public var selectedKeyboardID: String = ""
    @Published public var keyboardStatusText = "未取得"
    @Published public var vialStatusText = "未実行"
    @Published public var matrixRowsText: String
    @Published public var matrixColsText: String
    @Published public var keymapStatusText = "未実行"
    @Published public var keymapPreviewText = "-"
    @Published public var diagnosticsLogText = "-"
    @Published public var isDiagnosticsRunning = false
    @Published public var ignoredDeviceCount = 0
    @Published public var availableLayerCount = 1
    @Published public var selectedLayerIndex = 0
    @Published public var layoutChoices: [VialLayoutChoiceValue] = []
    ...
    public init(appDependencies: AppDependencies = .keyMapRenderLive) {
    ...
    public func probeVialOnSelectedKeyboard() {
    ...
    public func readFullVialKeymapOnSelectedKeyboard() {
    ...
    public func applySelectedLayerToLatestDump() {
    ...
    public func setSelectedLayerIndex(_ newValue: Int) {
    ...
    public func updateLayoutChoice(index: Int, selected: Int) {
    ...
    public func autoDetectMatrixOnSelectedKeyboard() {
        runSelectedKeyboardWorkflow(
    ...
    public func exportVialDefinitionOnSelectedKeyboard() {
        runSelectedKeyboardWorkflow(
    ...
    public func copyDiagnosticsLog() {
        rootStore.copyToClipboard(diagnosticsLogText)
    }

    public func ignoreSelectedKeyboard() {
    ...
    public func clearIgnoredKeyboards() {
